...
import { upAnim_4px } from "../../utils/constants";
...
export default function Competency({
  ...
  return (
    <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-7 lg:gap-8">
      {data.map((s, i) => {
        ...
        return (
          <article
            id={`category ${s.title}`}
            key={s.title}
            className={`flex flex-col justify-between bg-white dark:bg-slate-800/50 dark:border-slate-700/50 border border-slate-200 rounded-2xl p-5 md:p-7 lg:p-8 ${color.shadow}
          ...
          >
            <div className="flex items-start gap-4 md:gap-5 lg:gap-6 mb-5 md:mb-6">
              ...
              <div className="flex-1">
                <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-slate-900 dark:text-primary mb-2">
                  {s.title}
                </h3>
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4">
              <div className="flex justify-between text-xs md:text-sm mb-2">
                <span className="font-medium text-slate-700 dark:text-muted">
                  {units[0]}
                </span>
...
const skillColors: CardColor[] = [
  {
    icon: {
      ...
      bg: "bg-tone1-50 dark:bg-tone1-600/20",
    },
    bg: "",
    border: "",
    ...
    tags: [
      {
        text: "text-tone1-600 dark:text-tone1-400",
        bg: "from-tone1-600 to-tone1-400 dark:from-tone1-700 dark:to-tone1-300",
      },
    ],
  },
  {
    icon: {
      ...
      bg: "bg-tone2-50 dark:bg-tone2-600/20",
    },
    bg: "",
    border: "",
    ...
    tags: [
      {
        text: "text-tone2-600 dark:text-tone2-400",
        bg: "from-tone2-600 to-tone2-400 dark:from-tone2-700 dark:to-tone2-300",
      },
    ],
  },
  {
    icon: {
      ...
      bg: "bg-tone3-50 dark:bg-tone3-600/20",
    },
    bg: "",
    border: "",
    ...
    tags: [
      {
        text: "text-tone3-600 dark:text-tone3-400",
        bg: "from-tone3-600 to-tone3-400 dark:from-tone3-700 dark:to-tone3-300",
      },
    ],
  },
  {
    icon: {
      ...
      bg: "bg-tone4-50 dark:bg-tone4-600/20",
    },
    bg: "",
    border: "",
    ...
    tags: [
      {
        text: "text-tone4-600 dark:text-tone4-400",
        bg: "from-tone4-600 to-tone4-400 dark:from-tone4-700 dark:to-tone4-300",
      },
    ],
  },
];
