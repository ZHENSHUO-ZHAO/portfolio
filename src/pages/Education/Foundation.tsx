    ...
    <div className="grid min-[690px]:grid-cols-3 gap-6 md:gap-8 lg:mx-8">
      {data.map((d, i) => {
        ...
        return (
          <div
            key={d.title}
            className="relative flex flex-col justify-between bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-8 hover:bg-white/10 active:bg-white/10 transition duration-300"
          >
