...
void main() {
  ...
  q += toward * uMouseInfluence * 0.2;
    ...
    gl_FragColor = uPreliminaryAlpha > 0 ? vec4(rgb, a) : vec4(col, a);
...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uNoise: { value: noise },
        uPreliminaryAlpha: { value: usePreliminaryAlpha ? 1 : 0 },
      },
  ...
  }, [usePreliminaryAlpha, scale, colors]);
