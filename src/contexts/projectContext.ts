      ...
      items: [
        {
          ...
          screenshots: {
            ...
            images: createImageDataBatch(yoplayScreenshots, [
              ...
              "An online Crash gambling game interface. A panda character on a rocket is flying up a graph with a large multiplier of 29.82X displayed in the center.",
              "Birds and Beasts multiplayer slot game interface with animal-themed betting mechanics.",
              ...
              "Fortune Wheel multiplayer slot game interface.",
              "Yoplay Scratch Card interface displays various themed scratch card games with different max prizes and entry costs.",
              "Yo Bull multiplayer card game interface based on traditional Chinese poker rules.",
              "Forest Dance multiplayer slot game interface with animal-themed betting mechanics.",
              "Crazy Texas multiplayer card game interface where you bet on whether the Cowboy hand or the Bull hand will win.",
              "Two Kingdoms multiplayer slot game interface with ancient Chinese dynasty war theme.",
