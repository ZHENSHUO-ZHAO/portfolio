    ...
    items: [
      {
        ...
        tasks: [
          "Facilitate workshops on Agile delivery, software development methodologies, sprint planning, project governance, and collaborative software engineering practices for Bachelor of Information Technology and Master of Information Technology students.",
          "Guide student teams through industry-style software projects spanning the full software development lifecycle (SDLC), including requirements elicitation, wireframing, prototyping, development, testing, deployment, and evaluation.",
          "Mentor students in analysing client requirements, refining product backlogs, writing user stories, defining acceptance criteria, estimating effort, and prioritising development activities.",
          "Coach students in Agile practices, including sprint planning, backlog refinement, sprint reviews, retrospectives, stakeholder communication, and cross-functional collaboration.",
          "Incorporate industry case studies, team-based projects, and practical development activities to strengthen technical skills, critical thinking, and professional readiness.",
          "Encourage the responsible use of AI-assisted tools by guiding students to evaluate, validate, and refine AI-generated outputs while maintaining ownership of their decisions.",
          "Gather student feedback throughout the semester and continuously refine teaching methods, learning activities, and support strategies to improve engagement and learning outcomes.",
          "Guide students in using Agile project management tools including Jira and Trello for backlog tracking, documentation, sprint planning, and team collaboration.",
        ],
