    ...
    items: [
      {
        ...
        tasks: [
          ...
          "Guide student teams through industry-style software projects covering the full software development lifecycle (SDLC), including requirements elicitation, wireframing, prototyping, development, testing, deployment, and post-release evaluation.",
          "Mentor students in analysing client requirements and elicitation notes, refining product backlogs, writing user stories, defining acceptance criteria, estimating effort, and prioritising development activities.",
          "Coach students on Agile project practices including sprint planning, backlog refinement, sprint reviews, retrospectives, stakeholder communication, and cross-functional teamwork.",
          "Encourage responsible use of AI tools in software development and project activities, guiding students to evaluate AI-generated suggestions, apply critical reasoning, and maintain ownership of technical decisions.",
